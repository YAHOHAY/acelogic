...
class TableState(TypedDict):
    ...
    player_total_invested: Dict[str, str]  # 【新增】玩家总共已经下注的金额。(结算时候要用到)
...
def player_node(state: TableState):
    ...
    new_player_total_invested = dict(state["player_total_invested"])
    ...
    new_player_total_invested[name] += actual_cost
    ...
    return {
        ...
        "player_total_invested" : new_player_total_invested,
